...
<template>
  <section id="welcome">
    ...
    <div>
      <h3>Training Plan</h3>
      <p>
        This training plan follows the structure known as the
        <power>bro split.</power>
      </p>
      <h5><i>Push &rarr; Pull &rarr; Legs &rarr; Repeat</i></h5>
    </div>
    <div class="card challenge">
      <h3>🔥 Your Challenge</h3>
      <p>Complete all your workouts and track your progress along the way!</p>
      <p>Do you accept?</p>
